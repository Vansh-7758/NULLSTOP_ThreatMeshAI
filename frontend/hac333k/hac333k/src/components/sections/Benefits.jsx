...
import { CheckCircle, Shield, Zap, TrendingUp, Lock, Eye } from 'lucide-react';
import { SectionHeading } from '../ui';
import { fadeUp, slideLeft, slideRight, stagger, inViewProps } from '../../lib/motion';
...
/* ── Benefit list item ─────────────────── */
function BenefitItem({ icon: Icon, text, accent }) {
  return (
